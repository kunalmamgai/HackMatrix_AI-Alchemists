...
export default function Hero({ onSearchClick, darkMode }) {
  ...
  return (
    <section 
      id="hero"
      className={`min-h-screen flex items-center justify-center pt-20 overflow-hidden ${darkMode ? 'bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900' : 'bg-gradient-to-b from-white via-eco-50 to-ocean-50'}`}
    >
