...
export default function DrawerEstimator() {
  ...
  return (
    <section id="drawer-estimator" className={`py-20 bg-gray-900`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-10 items-start">
          ...
          {/* Live total */}
          <motion.div
            className={`lg:sticky lg:top-24 rounded-3xl p-8 shadow-xl border-2 bg-gray-800 border-gray-700`}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            {selectedDevices.length === 0 ? (
              <div className={`text-center py-8 px-4 rounded-2xl border-2 border-dashed border-gray-600`}>
              ...
              <>
                <div className="space-y-5">
                  ...
                  <div className={`rounded-2xl p-4 bg-gray-900`}>
                    <p className={`text-sm font-semibold mb-2 flex items-center gap-1.5 text-eco-300`}>
